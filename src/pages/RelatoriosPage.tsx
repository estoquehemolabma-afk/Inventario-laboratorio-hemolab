      ...
      >
        ...
        <div className="bg-card rounded-xl shadow-card border border-border/50 p-6">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-3 gradient-sidebar rounded-xl">
              <Activity className="w-6 h-6 text-white" />
            </div>
            <div>
              <h2 className="font-display font-bold text-lg text-foreground">
                Resumo Geral Detalhado
              </h2>
              <p className="text-sm text-muted-foreground">
                Métricas detalhadas de equipamentos funcionando e déficit
              </p>
            </div>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-card/50 p-3 rounded border border-success/10">
                    <div className="flex items-center gap-2 text-muted-foreground mb-1">
                      ...
                      <span className="text-xs">Computadores</span>
                    </div>
          ...
          <div className="mt-6 pt-6 border-t border-border flex justify-between items-center">
            <div className="text-sm text-muted-foreground">
              * O "Total Geral" considera a soma de todos os equipamentos funcionando + equipamentos inexistentes (déficit).
            </div>
            <div className="text-right">
              <p className="text-sm text-muted-foreground uppercase tracking-wider font-semibold">Total Geral de Registros</p>
              <p className="text-3xl font-display font-bold text-primary">{stats.grandTotal}</p>
            </div>
          </div>
        </div>

        {/* Existing PDF Report Section */}
        <div className="max-w-2xl mx-auto">
          <div className="bg-card rounded-xl shadow-card border border-border/50 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="font-display font-bold text-lg text-foreground">
                  Gerar PDF por Unidade
                </h2>
                <p className="text-sm text-muted-foreground">
                  Documento PDF com o levantamento completo (Inventário)
                </p>
              </div>
            </div>
