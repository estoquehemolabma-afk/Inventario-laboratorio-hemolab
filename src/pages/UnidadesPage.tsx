...
const UnidadesPage: React.FC = () => {
  ...
  const filteredUBS = ubsList.filter((ubs) => {
    ...
    return (
      ...
      ubs.responsible.toLowerCase().includes(query)
    );
  });
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Gerencie as UBS cadastradas no sistema
            </p>
          </div>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja excluir esta unidade? Todos os equipamentos associados também serão removidos.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
